...
def optimize_MLE_merge_guess(guess1):
	...
	WN = WHE_NSE(guess1[12],guess1[13],guess1[14],guess1[15],guess1[16],t_matrix_1,noise_mat_1,s_matrix_9,s_matrix_10,s_matrix_11,s_matrix_12,s_matrix_13)
	
	K_1 = K1 + K2 + K3 + K4 + K5 + K6 + K7 + K8 + WN
...
guess_file = wkspc + 'modes_K_prior.csv'	
guess_orig_tmp = numpy.genfromtxt(guess_file,delimiter=",")

guess_orig[0:2] = guess_orig_tmp[0,0:2]
guess_orig[4:6] = guess_orig_tmp[0,2:4]
guess_orig[8:] = guess_orig_tmp[0,4:]
...
stepsizes = numpy.array([guess_orig_2])/10.0
