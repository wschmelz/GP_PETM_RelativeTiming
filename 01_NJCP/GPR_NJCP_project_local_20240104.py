...
output_matrix_5 = numpy.zeros((MCMC_iteratoins,len(t_vals)))
output_matrix_6 = numpy.zeros((MCMC_iteratoins,len(t_vals)))
output_matrix_7 = numpy.zeros((MCMC_iteratoins,len(t_vals)))
output_matrix_8 = numpy.zeros((MCMC_iteratoins,len(t_vals)))
...
for index_Kdat in range(2,3):
	...
	if index_Kdat == 2:
		K_data = hyperparams_tmp[50000:,:]*1.0
	if index_Kdat > 3 and (index_Kdat != 2011 and index_Kdat != 2012):
		K_data = numpy.append(K_data,hyperparams_tmp[0:,:],axis=0)
...
output_matrix_7 = numpy.zeros((MCMC_iteratoins,n_SL_1))
...
for MCMC_index in range(0,MCMC_iteratoins):
	...
	K5_1 = linear4(guess1[8],new_mults_t_1,s_matrix_2)
	K6_1 = linear4(guess1[9],new_mults_t_1,s_matrix_3)
	
	K7_1 = linear4(guess1[10],new_mults_t_1,s_matrix_4)
	K8_1 = linear4(guess1[11],new_mults_t_1,s_matrix_5)

	K9_1 = matern(guess1[12],3.,numpy.absolute(guess1[13]),t_matrix_1) * s_matrix_4
	K10_1 = matern(guess1[14],3.,numpy.absolute(guess1[15]),t_matrix_1) * s_matrix_5	
	
	WN = WHE_NSE(guess1[16],guess1[17],guess1[18],guess1[19],guess1[20],t_matrix_1,noise_mat_1,s_matrix_9,s_matrix_10,s_matrix_11,s_matrix_12,s_matrix_13)

	K = K1_1 + K2_1 + K3_1 + K4_1 + K5_1 + K6_1 + K7_1 + K8_1 + K9_1 + K10_1 + WN
	...
	K5_2 =  linear4(guess1[8],t_mults_new_1,s_matrix_2_b)
	K6_2 =  linear4(guess1[9],t_mults_new_1,s_matrix_3_b)

	K7_2 =  linear4(guess1[10],t_mults_new_1,s_matrix_4_b)
	K8_2 =  linear4(guess1[11],t_mults_new_1,s_matrix_5_b)

	K9_2 =  matern(guess1[12],3.,numpy.absolute(guess1[13]),t_new_1) * s_matrix_4_b
	K10_2 =  matern(guess1[14],3.,numpy.absolute(guess1[15]),t_new_1) * s_matrix_5_b
	
	K2_f = K1_2 + K2_2 +  K3_2 + K4_2 + K5_2 + K6_2 + K7_2 + K8_2 + K9_2 + K10_2
	...
	K5_3 =  linear4(guess1[8],t_matrix2_mult_1,s_matrix_2_c)
	K6_3 =  linear4(guess1[9],t_matrix2_mult_1,s_matrix_3_c)
	
	K7_3 =  linear4(guess1[10],t_matrix2_mult_1,s_matrix_4_c)
	K8_3 =  linear4(guess1[11],t_matrix2_mult_1,s_matrix_5_c)			

	K9_3 =  matern(guess1[12],3.,numpy.absolute(guess1[13]),t_matrix2_1) * s_matrix_4_c
	K10_3 =  matern(guess1[14],3.,numpy.absolute(guess1[15]),t_matrix2_1) * s_matrix_5_c
		
	K_2 = K1_3 + K2_3 + K3_3 + K4_3 + K5_3 + K6_3 + K7_3 + K8_3 + K9_3 + K10_3
	...
	K2_f = K1_2 + K2_2 +  K3_2 + K4_2 + K5_2 + K6_2
	...
	K_2 = K1_3 + K2_3 + K3_3 + K4_3 + K5_3 + K6_3
	...
	output_matrix_7[MCMC_index,:] = xes1_t_1
